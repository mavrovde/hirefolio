...
echo
echo "Phone pings: set BEACONFOLIO_TELEGRAM_BOT_TOKEN + _CHAT_ID for instant Telegram"
echo "notifications (2 minutes with @BotFather; see README). Slack/ntfy: BEACONFOLIO_NOTIFY_WEBHOOK_URL."

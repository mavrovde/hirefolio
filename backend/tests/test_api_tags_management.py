...
async def test_list_tags(client: AsyncClient):
    ...
    await client.post("/api/posts", json={"title": "P1", "slug": "p1", "content": "c", "tags": ["python", "api"]})
    await client.post("/api/posts", json={"title": "P2", "slug": "p2", "content": "c", "tags": ["python", "web"]})
...
async def test_rename_tag(client: AsyncClient):
    ...
    # Setup
    await client.post("/api/posts", json={"title": "P1", "slug": "p1", "content": "c", "tags": ["old-tag"]})
...
async def test_delete_tag(client: AsyncClient):
    ...
    # Setup
    await client.post("/api/posts", json={"title": "P1", "slug": "p1", "content": "c", "tags": ["to-delete", "keep"]})

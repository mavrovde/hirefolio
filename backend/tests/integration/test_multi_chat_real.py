...
async def test_real_multi_chat_ollama_connection():
    ...
    # Setup simple agents
    agents = [
        AgentConfig(id=1, name="TestAgent1", role="Greeter", goal="Say hello", description="A friendly bot"),
        AgentConfig(id=2, name="TestAgent2", role="Responder", goal="Reply hello", description="Another friendly bot")
    ]

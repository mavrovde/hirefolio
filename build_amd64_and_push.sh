...
# amd64 images and publishes them to ghcr.io (ghcr.io/mavrovde/beaconfolio-* with
...
#                (default: $REGISTRY/mavrovde/beaconfolio; set explicitly for forks)
#
...
IMAGE_REPO="${IMAGE_REPO:-$REGISTRY/mavrovde/beaconfolio}"

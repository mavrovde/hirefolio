...
# # docker rmi "maverickde/mavrov.de-backend:$VERSION" "maverickde/mavrov.de-backend:latest" || true
...
# # docker rmi "maverickde/mavrov.de-proxy:$VERSION" "maverickde/mavrov.de-proxy:latest" || true
# # docker system prune -f || true
